...
public class UserServiceImpl implements UserService {
    ...
    public User registerUser(User user) {
        ...
        encodePassword(user);
        return saveUserWithAccount(user);
    }
    ...
    public String login(LoginRequest loginRequest, HttpServletRequest request)
        ...
        return generateAndSaveToken(user.getAccount().getAccountNumber());
    }
    ...
    public String generateOtp(OtpRequest otpRequest) {
        ...
        // We trigger the email, but return the success message string directly
        otpService.sendOTPByEmail(user.getEmail(), user.getName(), user.getAccount().getAccountNumber(), otp);

        return String.format(ApiMessages.OTP_SENT_SUCCESS.getMessage(), user.getEmail());
    }
