...
public enum ApiMessages {
    ...
    CASH_DEPOSIT_SUCCESS("Cash deposited successfully"),
    ...
    CASH_WITHDRAWAL_SUCCESS("Cash withdrawn successfully"),
    ...
    OTP_SENT_SUCCESS("OTP sent successfully to: %s"),
    ...
    PIN_CREATION_SUCCESS("PIN created successfully"),
